...
namespace DocumentLib
{
    public class Bitmap32
    {
        ...
        // Bitmap data.
        private System.Drawing.Imaging.BitmapData m_BitmapData;
        ...
        public void LockBitmap()
        {
            ...
            System.Runtime.InteropServices.Marshal.Copy(m_BitmapData.Scan0, ImageBytes, 0, total_size);
        }
        ...
        public void UnlockBitmap()
        {
            // Copy the data back into the bitmap.
            int total_size = m_BitmapData.Stride * m_BitmapData.Height;
            System.Runtime.InteropServices.Marshal.Copy(ImageBytes, 0, m_BitmapData.Scan0, total_size);
